...
M.base = {
    ...
    DiffAdd     = { fg = colors.green_func, bg = config.transparent_background and 'NONE' or colors.bg },
    DiffAdded   = { fg = colors.green_func, bg = config.transparent_background and 'NONE' or colors.bg },
    DiffChange  = { fg = colors.green_func, bg = config.transparent_background and 'NONE' or colors.bg },
...
M.plugins = {
    ...
    -----------------------------------------
    GitSignsAdd    = { fg = colors.green_func, bg =  config.transparent_background and 'NONE' or colors.bg },
    GitSignsChange = { fg = colors.diff_change, bg =  config.transparent_background and 'NONE' or colors.bg },
    GitSignsDelete = { fg = colors.red_key_w, bg =  config.transparent_background and 'NONE' or colors.bg },
    -----------------------------------------
    ...
    NvimTreeNormal           = { fg = colors.white1, bg = "NONE" },
